...
<div class="max-w-5xl">
  <h1 class="text-white text-6xl sm:text-6xl font-serif font-bold leading-tight">Japan</h1>
  <nav class="mt-3 text-white text-sm font-normal flex space-x-2 select-none" aria-label="Breadcrumb">
      ...
      <span class="text-white/70">/</span>
      <span aria-current="page" class="opacity-80">Japan</span>
...
<head>
 ...
 <body class="bg-white">
  <div class="max-w-7xl mx-auto px-6 py-24 flex flex-wrap gap-6">
   <!-- Card 1 -->
   <div class="relative w-full max-w-md rounded-lg overflow-hidden group cursor-pointer">
  <img
  ...
  <div class="absolute bottom-6 left-6 text-white max-w-[90%]">
    ...
    <div class="flex items-center gap-2 mb-2 text-sm">
      ...
      <span>6 Days - 6 Nights</span>
    </div>
    <div class="flex items-center gap-2 mb-4 text-sm">
      <i class="far fa-calendar-alt"></i>
      <span>All New Year ( Dec - Apr )</span>
    </div>
    <p class="text-sm">₹39.00</p>
    <br>
    <a href="#" class="opacity-0 group-hover:opacity-100 transition-opacity duration-500 inline-block bg-[#d9f99d] text-black text-sm font-semibold px-4 py-2 rounded-full shadow-md hover:bg-[#0c4a60]">
      Explore Trip
    </a>
   ...
   <!-- Card 2 -->
   <div class="relative w-full max-w-md rounded-lg overflow-hidden group cursor-pointer">
    <img alt="Japan Ancient Tour with traditional pagoda and Mount Fuji at sunset with cherry blossoms" 
    class="w-full h-auto object-cover rounded-lg transform transition-transform duration-500 group-hover:scale-110"
     height="400" src="https://storage.googleapis.com/a1aa/image/1775dd11-3d68-43d1-55f3-87572af1c892.jpg" width="600"/>
    <div class="absolute inset-0 bg-gradient-to-t from-[#0f3a4a] to-transparent rounded-lg group-hover:from-black/70">
    ...
    <div class="absolute bottom-6 left-6 text-white max-w-[90%]">
     ...
     <br>
     <a href="#" class="opacity-0 group-hover:opacity-100 transition-opacity duration-500 inline-block bg-[#c4d86f] text-black text-sm font-semibold px-4 py-2 rounded-full shadow-md hover:bg-[#0c4a60]">
      Explore Trip
    </a>
    </div>
    </div>
